...
export function fillParameters(
	...
	for (const [name, entry] of Object.entries(declared)) {
		...
		// A default is a literal the document states, never a reference: every one of them in the
		// corpus is a number or a byte string. Resolving it as a reference would make a default
		// that happens to look like a name mean something else entirely.
