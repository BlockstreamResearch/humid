 ...
 * part of what the document says, and a wallet with an order of its own honours its own habit
 * instead. Where the two agree nothing is lost, and where they disagree the habit builds a
 * transaction the contract rejects while the wallet that could have built the right one refuses
 * to build anything.
 *
