 ...
 *
 * The reference implementation parses this and checks nothing. Being stricter here is
 * deliberate, on the ground that a refusal before signing beats a rejection after it.
 */
 ...
 * knowing how many there are, which is why the totals are arguments rather than something this
 * works out for itself. Getting that wrong silently would place a piece one off the end.
 */
