...
// AC-07 and AC-08. The page's whole content is the runtime's own construct table, so what is
// checked here is that all of it arrives, that what the wallet cannot do leads, and that every
// gap carries its reason — the part no document can ever show, because no published protocol
...
describe("what this wallet does not implement", () => {
	...
	// hand: a sentence saying "seven" survives an eighth being added.
...
describe("the page stands alone", () => {
	// AC-07's other half and AC-10. It holds no wallet context and reads no document: every other
	// surface in this app reads a wallet context, and reading a missing one would throw.
