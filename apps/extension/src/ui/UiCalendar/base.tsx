...
import { UiButton as Button, UiButtonVariants as buttonVariants } from "@/ui/UiButton/base";

function getLocaleCode(locale?: Partial<Locale>) {
	return "code" in (locale ?? {})
		? (locale as Partial<Locale> & { code?: string }).code
		: undefined;
}
	...
	return (
		<DayPicker
			...
			components={{
				...
				DayButton: ({ ...props }) => <CalendarDayButton localeCode={localeCode} {...props} />,
...
export {
	...
	CalendarDayButton as UiCalendarDayButton,
};
