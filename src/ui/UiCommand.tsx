...
import { UiInputGroup, UiInputGroupAddon } from "@/ui/UiInputGroup";
...
function CommandDialog({
	...
	...props
}: Omit<React.ComponentProps<typeof UiDialog>, "children"> & {
	title?: string;
	description?: string;
	className?: string;
...
function CommandInput({
	...
	return (
		<div data-slot="command-input-wrapper" className="p-1 pb-0">
			<UiInputGroup className="border-input/30 bg-input/30 h-8! rounded-lg! shadow-none! *:data-[slot=input-group-addon]:pl-2!">
