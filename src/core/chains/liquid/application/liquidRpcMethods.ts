 ...
 * self-describing wrapped method (carrying its own id + capability); the router
 * derives the dispatcher, the advertised method names, and the connect-time
 * capabilities from this one list. Adding or removing a method is a one-line edit
 * here — nothing else to keep in sync. Ordered by capability group for a sensible
 * default order in the connect UI.
 */
